...
class BCEBlurWithLogitsLoss(nn.Module):
    ...
    def __init__(self, alpha=0.05):
        """Initializes a modified BCEWithLogitsLoss with reduced missing label effects."""
        super().__init__()
        self.loss_fcn = nn.BCEWithLogitsLoss(reduction="none")
        self.alpha = alpha

    def forward(self, pred, true):
        """Computes modified BCE loss with reduced missing label effects."""
...
class FocalLoss(nn.Module):
    ...
    def __init__(self, loss_fcn, gamma=1.5, alpha=0.25):
        """Initializes FocalLoss with given loss function, gamma, and alpha values."""
        super().__init__()
...
class ComputeLoss:
    ...
    def __init__(self, model, autobalance=False):
        """Initializes ComputeLoss with model and autobalance option."""
    ...
    def __call__(self, p, targets):
        """Performs forward pass, calculating class, box, and object loss."""
    ...
    def build_targets(self, p, targets):
        """Prepares model targets for loss computation."""
